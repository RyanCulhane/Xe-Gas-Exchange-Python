...
{
  double* ht_adAzimu = calloc(num_projPerFrame, sizeof(double));
  double* ht_adPolar = calloc(num_projPerFrame, sizeof(double));
...
double* gen_traj(long m_lProjectionsPerFrame, long m_lTrajectoryType)
{

  double* m_adAzimuthalAngle = calloc(m_lProjectionsPerFrame, sizeof(double));
  double* m_adPolarAngle = calloc(m_lProjectionsPerFrame, sizeof(double));
  double* coordinates = calloc(m_lProjectionsPerFrame*3, sizeof(double));
